...
{
    public class CreateAlumnoHandler : IRequestHandler<CreateAlumnoCommand, AlumnoDto>
    {
        ...
        public async Task<AlumnoDto> Handle(CreateAlumnoCommand request, CancellationToken cancellationToken)
        {
            ...
            return _mapper.Map<AlumnoDto>(obj);
        }
    }
}
